...
STRATEGIES = [
    {
        'name': 'Client Android Music (Optimise pour audio)',
        'args': ['--extractor-args', 'youtube:player_client=android_music', '--no-check-certificates'],
    },
    {
        'name': 'Client Web Mobile (Sans JS challenges)',
        'args': ['--extractor-args', 'youtube:player_client=mweb', '--no-check-certificates'],
    },
    {
        'name': 'Cookies Firefox + Client Android',
        'args': ['--cookies-from-browser', 'firefox', '--extractor-args', 'youtube:player_client=android_music', '--no-check-certificates'],
    },
    {
        'name': 'Client Android Embedded',
        'args': ['--extractor-args', 'youtube:player_client=android_embedded', '--no-check-certificates'],
    },
    {
        'name': 'Cookies Firefox + Client Web',
        'args': ['--remote-components', 'ejs:github', '--cookies-from-browser', 'firefox', '--no-check-certificates'],
    },
    {
    ...
    },
    {
        ...
        'args': ['--extractor-args', 'youtube:player_client=android,web', '--no-check-certificates'],
    },
    {
        'name': 'Mode legacy (Dernier recours)',
        'args': ['--no-check-certificates', '--extractor-args', 'youtube:skip=dash,hls'],
    },
]
